...
public class JavaAPISuite implements Serializable {
  ...
  public void sampleByKey() {
    ...
    Map<Integer, Long> worCounts = (Map<Integer, Long>) (Object) wr.countByKey();
  ...
  public void sampleByKeyExact() {
    ...
    fractions.put(0, 0.5);
    fractions.put(1, 1.0);
    JavaPairRDD<Integer, Integer> wr = rdd2.sampleByKeyExact(true, fractions, 1L);
    Map<Integer, Long> wrCounts = (Map<Integer, Long>) (Object) wr.countByKey();
    Assert.assertTrue(wrCounts.size() == 2);
    Assert.assertTrue(wrCounts.get(0) == 2);
    Assert.assertTrue(wrCounts.get(1) == 4);
    JavaPairRDD<Integer, Integer> wor = rdd2.sampleByKeyExact(false, fractions, 1L);
    Map<Integer, Long> worCounts = (Map<Integer, Long>) (Object) wr.countByKey();
    Assert.assertTrue(worCounts.size() == 2);
    Assert.assertTrue(worCounts.get(0) == 2);
    Assert.assertTrue(worCounts.get(1) == 4);
  }
}
